...
**
*******************************************************************************/
static bt_status_t btc_hf_client_send_xapl(void)
{
    CHECK_HF_CLIENT_SLC_CONNECTED();

    BTA_HfClientSendAT(btc_hf_client_cb.handle, BTA_HF_CLIENT_AT_CMD_XAPL, 0, 0, NULL);
...
**
*******************************************************************************/
static bt_status_t btc_hf_client_send_iphoneaccev(uint8_t battery_level, bool docked)
{
    CHECK_HF_CLIENT_SLC_CONNECTED();

    BTA_HfClientSendAT(btc_hf_client_cb.handle, BTA_HF_CLIENT_AT_CMD_IPHONEACCEV, battery_level, docked, NULL);
...
void btc_hf_client_call_handler(btc_msg_t *msg)
{
    ...
    case BTC_HF_CLIENT_SEND_IPHONEACCEV_EVT:
        btc_hf_client_send_iphoneaccev(arg->iphone_headset_state_param.battery_level, arg->iphone_headset_state_param.docked);
        break;
    default:
