...
esp_err_t esp_event_loop_init(system_event_cb_t cb, void *ctx)
{
    ...
    uint8_t *event_queue_stack = heap_caps_calloc(1, ESP_TASKD_EVENT_STACK, MALLOC_CAP_SPIRAM);
    xTaskCreateStaticPinnedToCore(esp_event_loop_task, "eventTask",
            ESP_TASKD_EVENT_STACK, NULL, ESP_TASKD_EVENT_PRIO, event_queue_stack, &event_task_buf, 0);
